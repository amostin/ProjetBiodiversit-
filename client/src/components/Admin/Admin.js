...
class Admin extends Component {
  ...
  renderPlaces = ({
    ...
    <tr key={idPoint}>
      ...
      <td>{fin}</td>
      <td>{accessibilite}</td>
      <td><button className="deleteButton" onClick={() => this.deletePoint({idPoint})}>Supprimer</button></td>
      <td><button className="modifyButton" onClick={() => this.updatePoint({idPoint})}>Modifier</button></td>
    </tr>
  );
